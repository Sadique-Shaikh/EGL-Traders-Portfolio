        ...
        >
            <div className="pmodal" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="pmodal-right">
                    ...
                    <h2 className="pmodal-name">{activeItem.name}</h2>
                    <p className="pmodal-tagline">{details.tagline}</p>
                    <p className="pmodal-desc">{activeItem.desc}</p>
                        ...
                        <div className="pmodal-section">
                            ...
                            <div className="pmodal-specs">
                                {Object.entries(details.specs).map(([key, val]) => (
                                    <div key={key} className="pmodal-spec-card">
                    ...
                    {/* Related — other items in same category */}
                    <div className="pmodal-section">
